...
public final class GameBoard implements InterfaceGetState {
    ...
    public GameBoard(final CivilisationCardDeck deck, final ArrayList<Building> buildings,
        ...
        CivilisationCardPlace card4 = new CivilisationCardPlace(deck, deck.getTop(), null, REQUIRED_RESOURCES_CARD4,
                evaluate);
        CivilisationCardPlace card3 = new CivilisationCardPlace(deck, deck.getTop(), card4, REQUIRED_RESOURCES_CARD3,
                evaluate);
        CivilisationCardPlace card2 = new CivilisationCardPlace(deck, deck.getTop(), card3, REQUIRED_RESOURCES_CARD2,
                evaluate);
        CivilisationCardPlace card1 = new CivilisationCardPlace(deck, deck.getTop(), card2, REQUIRED_RESOURCES_CARD1,
                evaluate);
